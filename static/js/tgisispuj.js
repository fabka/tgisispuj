...
$(".titulo-aplicado-button-item").click(function() {
  ...
  $(".titulo-aplicado-button-item").text(tituloAplicado);
});
...
//botón módulo administrativo
$(document).on('click', '#admin-button', function(e) {
    window.location="/admin";
});
//Botón github
$(document).on('click', '#github-button', function(e) {
    window.location="https://github.com/fabka/tgisispuj";
});
